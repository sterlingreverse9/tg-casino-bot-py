...
class TicTacToeGame:
    def __init__(self, game_id, player1_id, player1_name, player2_id, player2_name, bet_amount):
        ...
        # Randomly assign X (starts first) and O
        if random.choice([True, False]):
            self.x_player = (player1_id, player1_name)
            self.o_player = (player2_id, player2_name)
        else:
